...
// pass data ------------------------------------------------------------------
const nextRound = document.querySelectorAll(".nextround")

const urlParams = new URLSearchParams(document.location.search)

nextRound.forEach((div) => {
    div.addEventListener("click", evt => {
        document.location = `/round-2.html?p1s=${player1Score}&&p2s=${player2Score}`
    })
})

const passPlayer1Score = urlParams.get('p1s')

const passPlayer2Score = urlParams.get('p2s')
